...
('Guilherme Barros', 'gui.barros@email.com'),
('Kátia Abreu', 'katia.abreu@email.com'),
('Leonardo Torres', 'leo.torres@email.com'),
('Mônica Valente', 'monica.valente@email.com');
